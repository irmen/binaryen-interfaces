...
try:
    ...
    ArrayCmpxchgId = lib.BinaryenArrayCmpxchgId
    ...
    ArrayFill = lib.BinaryenArrayFill
    ArrayFillGetIndex = lib.BinaryenArrayFillGetIndex
    ArrayFillGetRef = lib.BinaryenArrayFillGetRef
    ArrayFillGetSize = lib.BinaryenArrayFillGetSize
    ArrayFillGetValue = lib.BinaryenArrayFillGetValue
    ArrayFillId = lib.BinaryenArrayFillId
    ArrayFillSetIndex = lib.BinaryenArrayFillSetIndex
    ArrayFillSetRef = lib.BinaryenArrayFillSetRef
    ArrayFillSetSize = lib.BinaryenArrayFillSetSize
    ArrayFillSetValue = lib.BinaryenArrayFillSetValue
    ...
    ArrayInitData = lib.BinaryenArrayInitData
    ArrayInitDataGetIndex = lib.BinaryenArrayInitDataGetIndex
    ArrayInitDataGetOffset = lib.BinaryenArrayInitDataGetOffset
    ArrayInitDataGetRef = lib.BinaryenArrayInitDataGetRef
    ArrayInitDataGetSegment = lib.BinaryenArrayInitDataGetSegment
    ArrayInitDataGetSize = lib.BinaryenArrayInitDataGetSize
    ArrayInitDataId = lib.BinaryenArrayInitDataId
    ArrayInitDataSetIndex = lib.BinaryenArrayInitDataSetIndex
    ArrayInitDataSetOffset = lib.BinaryenArrayInitDataSetOffset
    ArrayInitDataSetRef = lib.BinaryenArrayInitDataSetRef
    ArrayInitDataSetSegment = lib.BinaryenArrayInitDataSetSegment
    ArrayInitDataSetSize = lib.BinaryenArrayInitDataSetSize
    ArrayInitElem = lib.BinaryenArrayInitElem
    ArrayInitElemGetIndex = lib.BinaryenArrayInitElemGetIndex
    ArrayInitElemGetOffset = lib.BinaryenArrayInitElemGetOffset
    ArrayInitElemGetRef = lib.BinaryenArrayInitElemGetRef
    ArrayInitElemGetSegment = lib.BinaryenArrayInitElemGetSegment
    ArrayInitElemGetSize = lib.BinaryenArrayInitElemGetSize
    ArrayInitElemId = lib.BinaryenArrayInitElemId
    ArrayInitElemSetIndex = lib.BinaryenArrayInitElemSetIndex
    ArrayInitElemSetOffset = lib.BinaryenArrayInitElemSetOffset
    ArrayInitElemSetRef = lib.BinaryenArrayInitElemSetRef
    ArrayInitElemSetSegment = lib.BinaryenArrayInitElemSetSegment
    ArrayInitElemSetSize = lib.BinaryenArrayInitElemSetSize
    ...
    ArrayNewDataGetOffset = lib.BinaryenArrayNewDataGetOffset
    ArrayNewDataGetSegment = lib.BinaryenArrayNewDataGetSegment
    ArrayNewDataGetSize = lib.BinaryenArrayNewDataGetSize
    ArrayNewDataId = lib.BinaryenArrayNewDataId
    ArrayNewDataSetOffset = lib.BinaryenArrayNewDataSetOffset
    ArrayNewDataSetSegment = lib.BinaryenArrayNewDataSetSegment
    ArrayNewDataSetSize = lib.BinaryenArrayNewDataSetSize
    ArrayNewElem = lib.BinaryenArrayNewElem
    ArrayNewElemGetOffset = lib.BinaryenArrayNewElemGetOffset
    ArrayNewElemGetSegment = lib.BinaryenArrayNewElemGetSegment
    ArrayNewElemGetSize = lib.BinaryenArrayNewElemGetSize
    ArrayNewElemId = lib.BinaryenArrayNewElemId
    ArrayNewElemSetOffset = lib.BinaryenArrayNewElemSetOffset
    ArrayNewElemSetSegment = lib.BinaryenArrayNewElemSetSegment
    ArrayNewElemSetSize = lib.BinaryenArrayNewElemSetSize
    ...
    ArrayRMWId = lib.BinaryenArrayRMWId
    ...
    AtomicCmpxchgGetMemoryOrder = lib.BinaryenAtomicCmpxchgGetMemoryOrder
    ...
    AtomicCmpxchgSetMemoryOrder = lib.BinaryenAtomicCmpxchgSetMemoryOrder
    ...
    AtomicRMWGetMemoryOrder = lib.BinaryenAtomicRMWGetMemoryOrder
    ...
    AtomicRMWSetMemoryOrder = lib.BinaryenAtomicRMWSetMemoryOrder
    ...
    ElemDropId = lib.BinaryenElemDropId
    ...
    FeatureRelaxedAtomics = lib.BinaryenFeatureRelaxedAtomics
    ...
    GetMaxCombinedBinarySize = lib.BinaryenGetMaxCombinedBinarySize
    ...
    LoadGetMemoryOrder = lib.BinaryenLoadGetMemoryOrder
    ...
    LoadSetMemoryOrder = lib.BinaryenLoadSetMemoryOrder
    ...
    MemoryOrderAcqRel = lib.BinaryenMemoryOrderAcqRel
    MemoryOrderSeqCst = lib.BinaryenMemoryOrderSeqCst
    MemoryOrderUnordered = lib.BinaryenMemoryOrderUnordered
    ...
    RefGetDescId = lib.BinaryenRefGetDescId
    ...
    ReturnCallRef = lib.BinaryenReturnCallRef
    ...
    SetMaxCombinedBinarySize = lib.BinaryenSetMaxCombinedBinarySize
    ...
    StoreGetMemoryOrder = lib.BinaryenStoreGetMemoryOrder
    ...
    StoreSetMemoryOrder = lib.BinaryenStoreSetMemoryOrder
    ...
    StringTestId = lib.BinaryenStringTestId
