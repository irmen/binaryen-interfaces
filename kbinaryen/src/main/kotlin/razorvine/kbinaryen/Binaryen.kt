...
//        }
    ...
    fun BinaryenAddTable(module: BinaryenModuleRef, table: String, initial: Int, maximum: Int): BinaryenTableRef
    ...
    fun BinayenElementSegmentIsPassive(elem: BinaryenElementSegmentRef): Boolean
